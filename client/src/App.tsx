...
function MobileContainer({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen bg-deep-space flex justify-center overflow-hidden">
      <div className="w-full max-w-[430px] min-h-screen relative shadow-2xl overflow-hidden">
        {children}
      </div>
    </div>
  );
